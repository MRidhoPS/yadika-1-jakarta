...
//                             <div className='text-black text-[14px] line-clamp-3' dangerouslySetInnerHTML={{ __html: blog.description }} />
//                             <div className='flex flex-row justify-between'>
//                                 <p className='text-[12px] pt-2 text-gray-500'> {formatDate(blog.createdAt)}</p>
